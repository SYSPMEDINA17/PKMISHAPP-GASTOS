      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl md:text-3xl font-black text-white tracking-tighter uppercase">Nodos de Salida</h1>
            </div>
            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] ml-13">Control de fugas de capital y consumo</p>
          </div>
          <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2">
               <span className="text-[9px] font-bold text-rose-500 uppercase tracking-widest bg-rose-500/10 px-2 py-1 rounded-lg">Consumo Detectado</span>
            </div>
          </motion.div>
          ...
          <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-6 bg-white/[0.01] border border-white/5 rounded-3xl flex items-center gap-4">
               ...
               <div>
                  <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Categoría Dominante</p>
            ...
            <div className="p-6 bg-white/[0.01] border border-white/5 rounded-3xl flex items-center gap-4">
               ...
               <div>
                  <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Alertas de Presupuesto</p>
                  <p className="text-lg font-bold text-white leading-tight">Sin Alertas</p>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-950/40 backdrop-blur-xl p-8 rounded-[40px] border border-white/5 shadow-2xl relative">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="text-xs font-black uppercase tracking-[0.4em] text-white">Log de Salidas Recientes</h3>
          </div>
